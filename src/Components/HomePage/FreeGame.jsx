...
export const FreeGame = () => {
  const freeGames = [
    {
      ...
      img: "https://videos-rockstargames-com.akamaized.net/screencaps/49/en_us/1280.jpg?im=Resize=640&quot",
      status: "Free now",
      endDate: "June 04 at 08:30 PM",
    },
    {
      id: "2",
      title: "L.A. Noire The Complete Edition",
      img: "https://videos-rockstargames-com.akamaized.net/screencaps/12010/en_us/1920.jpg?im=Resize=640&quot",
      status: "Upcoming",
      endDate: "",
    },
  ];
  return (
    <>
      <div className="bg-[#2a2a2a] px-8 py-8 rounded-md mb-12">
        <div className="">
          <div className="flex flex-row justify-between">
            <span className="flex flex-row items-center gap-4">
              ...
              <h2 className="font-semibold text-lg text-white">Free Games</h2>
            </span>

            <span>
              <button className="p-2 text-sm text-white font-semibold border border-white rounded-sm">
                View More
              </button>
            </span>
          </div>
        </div>
        <div className="grid grid-cols-2 gap-8 pt-8 cursor-pointer">
          {freeGames.map((free) => (
            <FreeGameCard key={free.id} free={free} />
          ))}
        </div>
      </div>
    </>
